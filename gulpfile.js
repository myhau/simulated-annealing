...
// Bundle
gulp.task('bundle', ['styles', 'workers', 'scripts', 'bower'], function() {
...
gulp.task('watch', ['html', 'fonts', 'bundle'], function() {
  ...
  gulp.watch('app/scripts/workers/**/*.js', ['workers'])
...
// Build
gulp.task('build', ['html', 'workers', 'buildBundle', 'images', 'fonts', 'extras'], function() {
